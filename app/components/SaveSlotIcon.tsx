 ...
 *
 * Palette: #8b6f47 aged wood, #c4a747 honey gold, #3d3a34 charcoal.
 * All paths use currentColor so the caller can tint with Tailwind / style.
 */
...
function OverworldGlyph() {
  ...
  return (
    <>
      ...
      />
      {/* Tree trunk */}
      <rect x="3.5" y="9" width="1" height="3" fill="#8b6f47" />
      {/* Tree crown */}
...
function DungeonGlyph() {
  ...
  return (
    <>
      {/* Handle */}
      <rect x="7" y="9" width="2" height="5" rx="0.5" fill="#8b6f47" />
      {/* Grip band */}
