...
import { R as React } from './index-BAe1oPKr.js';
...
const useGameStore = create((set, _get) => ({
  ...
  playerPosition: new Vector3(2, 1.6, 24),
  playerVelocityY: 0,
  velocity: 0,
  angularVelocity: 0,
  cameraYaw: Math.PI,
  ...
  startGame: (seed, position, yaw) => set({
    // Reset world state
    inDialogue: false,
    playerVelocityY: 0,
    velocity: 0,
  ...
  setCurrentChunk: (key, name, type) => set({
    currentChunkKey: key,
  ...
  startCombat: (encounter) => set({ inCombat: true, activeEncounter: encounter }),
  endCombat: () => set({ inCombat: false, activeEncounter: null }),
  setCurrentInteractable: (interactable) => set({ currentInteractable: interactable }),
  openDialogue: (name, text) => set({
    inDialogue: true,
    dialogueName: name,
    dialogueText: text
  }),
  ...
  setJoystick: (vector, dist) => set({ joystickVector: vector, joystickDist: dist }),
...
export { cyrb128 as a, create as b, cn as c, generateSeedPhrase as g, mulberry32 as m, useGameStore as u };
//# sourceMappingURL=utils-Ds8l1iD7.js.map
